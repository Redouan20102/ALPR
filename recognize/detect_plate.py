...
classes = {
    ...
    'horizental_symetry': ['159', '7', '4', '6', '02389', '236'],
    'vertical_symetry': ['46', '79', '3', '279', '024578', '1', '13'],
    'mean_vtd': ['047', '047', '023476', '235689'],
    'stddev_vtd': ['1', '14', '0147', '07', '236', '5689', '235689'],
    'mean_htd': ['0', '12357', '3456', '345', '69', '45', '7', '08', '689', '2345'],
    'stddev_htd': ['0689', '35', '2345', '23457', '47', '247', '17', '7']
}
'''
'hu7': ['47', '2347', '234569', '123569', '0123569', '02568', '058', '08', '0',
    'bottom_line_density': ['42', '01345689', '47']
'''
        ...
        for class0 in combined[keys[0]]:
            for class1 in combined[keys[1]]:
                ...
                if new_class == "":  # empty intersection, mass conflectuelle:
                    m12_omega += combined[keys[0]][class0] * combined[keys[1]][class1]
                else:
                    if new_class in new_masses:
                        ...
                        new_masses[new_class] = combined[keys[0]][class0] * combined[keys[1]][class1]
        if m12_omega != 1:
            for element in new_masses:
                new_masses[element] = new_masses[element] / (1 - m12_omega)
        combined.pop(keys[0])
        combined.pop(keys[1])
...
data_file = r'attributes_modified.csv'
lp_folder = "results"
